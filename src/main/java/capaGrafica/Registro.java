...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        FechaFinalizacion.setFont(new java.awt.Font("Segoe UI Historic", 2, 12)); // NOI18N
        ...
        FechaInicio.setFont(new java.awt.Font("Segoe UI Historic", 2, 12)); // NOI18N
        ...
        jLabel10.setFont(new java.awt.Font("Segoe UI Historic", 2, 12)); // NOI18N
        jLabel10.setText("Ej: 12/12/2025");
    ...
    if(NombreDocente.getText().trim().isEmpty()||
       ...
       FechaFinalizacion.getText().trim().isEmpty()||
       FechaInicio.getText().trim().isEmpty()){
        ...
        try {
            ...
            //verifica si el usuario ingreso un formato de fecha valido
            java.util.Date utilFechaInicio = sdf.parse(FechaInicio.getText().trim());
            java.util.Date utilFechaFinalizacion = sdf.parse(FechaFinalizacion.getText().trim());
            ...
            java.util.Date fechaActualSinHora = sdf.parse(sdf.format(fechaActual));
            
            //verifica si fecha de inicio es anterior a la fecha actual
            if (utilFechaInicio.before(fechaActualSinHora)) {
                JOptionPane.showMessageDialog(this, "La fecha de inicio no puede ser en el pasado\n" + "Debe ser igual o posterior a hoy: " + sdf.format(fechaActualSinHora));
                return;
            }

            //verifica si fecha de finalizacion es anterior a la fecha actual
            if (utilFechaFinalizacion.before(fechaActualSinHora)) {
                JOptionPane.showMessageDialog(this,  "La fecha de finalizacion no puede ser en el pasado\n" + "Debe ser igual o posterior a hoy: " + sdf.format(fechaActualSinHora));
                return;
            }

            //verifica si la fecha de inicio es posterior a fecha de finalizacion
            if (utilFechaInicio.after(utilFechaFinalizacion)) {
                JOptionPane.showMessageDialog(this, "La fecha de inicio no puede ser posterior a la fecha de finalizacion\n");
                return;
            }
            
            //verifica si la fecha de inicio ingresada este antes que la fecha finalizacion
            if (sqlFechaInicio.after(sqlFechaFinalizacion)) {
                JOptionPane.showMessageDialog(this, "La fecha de inicio no puede ser posterior a la fecha de finalizacion\n");
                return;
            }
